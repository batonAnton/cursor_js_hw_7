...
// getMySalary();
setInterval(()=>(console.log('Країна Україна: ' , getMySalary.call(ukraine))),1000);
setInterval(()=>(console.log('Країна Латвія: ' , getMySalary.call(latvia))),1000);
setInterval(()=>(console.log('Країна Литва: ' , getMySalary.call(litva))),1000);
